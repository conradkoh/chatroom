...
| 2   | busy before thinking        | Watch daemon logs during inject                                        | recordHarnessActivity on busy event                                               |
...
| 5   | Legacy no receipt           | Pre-migration or test chatroom without receipts                        | Acknowledged + native:task-injected + harness activity still works                |
