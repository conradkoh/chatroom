...
| R11 | cli · handoff command                 | `commands/handoff/index.ts` → direct `backend.mutation(api.messages.handoff, ...)`                                                                  | Direct CLI→Convex backend call; all backend access routes through the CLI gateway service (V17)                                              | ⬜   |
