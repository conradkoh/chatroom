...
export function appendEnhanceModeGuidance(lines: string[]): void {
  lines.push(
    ...
    'If architect or UI/UX engineer input is useful, you may delegate to either role as optional advisors. They are ordinary team roles; do not create a separate design task or use a special handoff ceremony.',
    '</enhance-mode>'
  );
}
