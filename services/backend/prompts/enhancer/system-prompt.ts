...
export function renderEnhancerSystemPrompt(params: RenderEnhancerSystemPromptParams): string {
  ...
  return [
    ...
    "- Run the **UX review checklist** in <ux-reference>; report **specific** findings tied to the planner's proposal under **Recommendations**.",
    '- Write "Not Applicable." for UX bullets when no UI changes are proposed.',
    '',
