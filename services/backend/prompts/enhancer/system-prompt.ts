...
export function renderEnhancerSystemPrompt(params: RenderEnhancerSystemPromptParams): string {
  ...
  return [
    ...
    '- Independently identify user intent, missing context, risks, failure modes, and 2–3 viable implementation approaches with tradeoffs.',
    '- Propose 2–3 viable approaches with tradeoffs rather than collapsing to one recommendation; the entry point chooses.',
    '- Use <additional-context> from the forwarded request as the entry point\'s supplementary intent; verify against downloaded history and repository evidence.',
