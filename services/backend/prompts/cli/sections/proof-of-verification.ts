 ...
 * handing off to `user`, using anchored message commands to
...
1. \`${anchorCmd}\` — locate the user's last message
2. \`${downloadCmd}\` — download grep-friendly history; read handoffs and goals
