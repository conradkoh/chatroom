...
export const releaseWorkflowSkill: SkillModule = {
  skillId: 'release-workflow',
  name: 'Release Workflow',
  description:
    'Standard release process: create release branch, raise PRs against it, squash-merge changes, then merge to master.',

  getPrompt: (
    _cliEnvPrefix: string
  ) => `You have been activated with the "release-workflow" skill.
