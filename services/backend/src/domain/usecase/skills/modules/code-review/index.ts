...
## How to activate sequential pillar review
...
- \`chatroom workflow step-view\` — see the current pillar's full content
- \`chatroom workflow step-complete\` — mark the current pillar done and unlock the next
