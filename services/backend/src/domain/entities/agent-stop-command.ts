...
export type { AgentStopScope, AgentStopTargetDescriptor } from '@workspace/shared/domain/agent-stop-command';
...
export const agentStopTargetStatusValidator = v.union(
  v.literal('pending'), v.literal('processing'), v.literal('completed'), v.literal('failed'), v.literal('superseded')
);
