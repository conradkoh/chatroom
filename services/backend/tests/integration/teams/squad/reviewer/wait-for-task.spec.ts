/**
 * Squad Team — Reviewer Wait For Task
 *
 * Verifies the full CLI output generated when a reviewer in a Squad team
...
describe('Squad Team > Reviewer > Wait For Task', () => {
  test('task from user', () => {
    ...
    expect(output).toMatchInlineSnapshot(`
      ...
      4. Hand off when complete:
         ...
         Available targets: builder, planner
