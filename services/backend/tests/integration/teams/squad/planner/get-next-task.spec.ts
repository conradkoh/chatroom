  ...
  test('task from user', () => {
    ...
    expect(output).toMatchInlineSnapshot(`
      ...
      **Phase Planning Loop:**
      ...
      Context compacted? Run \`CHATROOM_CONVEX_URL=http://127.0.0.1:3210 chatroom get-system-prompt --chatroom-id="test-chatroom-id" --role="planner"\` to reload your role prompt.
      ============================================================"
    `);
  });
