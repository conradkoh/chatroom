  ...
  test('system prompt for custom agent', async () => {
    ...
    expect(prompt).toMatchInlineSnapshot(`
      ...
      **Reference commands:**
      ...
      - Export message history (grep): \`CHATROOM_CONVEX_URL=http://127.0.0.1:3210 chatroom messages export --chatroom-id="000000000000010002chatroom_rooms" --role="planner"\`
