...
- [Daemon outbox acknowledgement and recovery](daemon-outbox-delivery.md) — local persistence acknowledgements, background retries, schema quarantine, and delivery barriers
