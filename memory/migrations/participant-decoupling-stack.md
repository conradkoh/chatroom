...
| 16  | —                                      | Core session / connection supersession           | Pending  | Highest    | `convex/participants.ts` (join, getByRole, recordHarnessActivity, connectionId); `convex/tasks.ts` (`connectionId` supersession in `getPendingTasksForRole`)                                                                                                                              |
