 ...
 *
 * Uses CLI-owned harness shared types. The MachineCapabilities wrapper is CLI-specific.
 */

import type { HarnessAgent, HarnessCapability, HarnessProvider } from './harness-shared-types.js';
