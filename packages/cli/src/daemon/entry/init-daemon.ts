...
import type { ChatroomLogSink, LogServer } from '../../infrastructure/log-server/index.js';
...
let activeLogSink: LogServer | undefined;

export function getActiveChatroomLogSink(): ChatroomLogSink | undefined {
...
export type InitDaemonOptions = { logSink?: LogServer };
