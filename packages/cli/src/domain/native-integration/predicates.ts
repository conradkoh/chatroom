...
export function isNativeInjectableAliveRunning(task: AssignedTaskLiteView): boolean {
...
export function isNativeAcknowledgedInjectionRetry(task: AssignedTaskLiteView): boolean {
...
// fallow-ignore-next-line complexity
export function isStaleCliGetNextTaskWaiting(task: AssignedTaskLiteView): boolean {
