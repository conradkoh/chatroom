/**
 * Subscribes to unprocessed user messages and dispatches them to the harness session.
 * WS subscription removed in U13 — v2 direct-harness-prompt subscriber nudges drains.
 */
...
import { resumeSession } from '../../../../v2/domain/usecase/resume-harness-session.js';
