...
function copyFile(src: string, dest: string): void {
  ...
  console.log(`✅ Copied: ${path.basename(src)} → ${path.relative(ROOT_DIR, dest)}`);
}
...
`;
  ...
  console.log(`✅ Generated: packages/cli/src/convex-api/index.ts`);
}
...
`;
  ...
  console.log(`✅ Generated: packages/cli/dist/convex-api/index.js`);
  ...
  console.log(`✅ Generated: packages/cli/dist/convex-api/index.d.ts`);
