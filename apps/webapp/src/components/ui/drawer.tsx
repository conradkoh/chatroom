...
function Drawer({
  ...
  showSwipeHandle?: boolean;
  /** Legacy vaul options retained for existing callers during migration. */
  container?: HTMLElement;
  nested?: boolean;
...
function DrawerTrigger({
  ...
  children,
  ...props
}: DrawerPrimitive.Trigger.Props & { asChild?: boolean; children?: React.ReactNode }) {
  return (
...
function DrawerClose({
  ...
  children,
  ...props
}: DrawerPrimitive.Close.Props & { asChild?: boolean; children?: React.ReactNode }) {
  return (
