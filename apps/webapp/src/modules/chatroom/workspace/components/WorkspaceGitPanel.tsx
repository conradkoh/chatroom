  ...
  return (
    <>
      <div className="flex flex-row h-full">
        ...
        {/* Content area */}
        <div className={cn('flex-1 overflow-y-auto', 'p-0')}>
          {activeTab === 'prs' && (
          ...
          {activeTab === 'diff' && (
            <WorkspaceDiffViewer
              state={fullDiffState}
              onRequest={requestDiff}
              machineId={machineId}
              workingDir={workingDir}
              onDiscard={requestDiff}
            />
          )}
              ...
              {activePR ? (
                ...
                <div className="flex flex-col items-center justify-center h-full gap-3 text-center px-6">
                  <div className="text-chatroom-text-muted text-[11px]">
                    ...
                    <span className="font-mono font-bold text-chatroom-text-secondary">
                      {gitState.status === 'available' ? gitState.branch : ''}
                    </span>
                  </div>
