...
export function AttachedTaskChip({ content, onRemove }: AttachedTaskChipProps) {
  ...
  return (
    <>
      ...
      {/* Slide-in panel — industrial chatroom theme */}
      <div
        className={`chatroom-root fixed top-0 right-0 h-full w-full md:w-[500px] lg:w-[600px] bg-chatroom-bg-primary border-l-2 border-chatroom-border-strong z-50 flex flex-col transition-transform duration-200 ${
