      ...
      >
        ...
        <DialogFooter>
          <button
            ...
            className="px-4 py-2 text-sm font-medium rounded-none border-2 border-chatroom-border-strong text-chatroom-text-primary bg-chatroom-bg-secondary hover:bg-chatroom-bg-hover transition-colors cursor-pointer"
          >
            Play test sound
          </button>
        </DialogFooter>
