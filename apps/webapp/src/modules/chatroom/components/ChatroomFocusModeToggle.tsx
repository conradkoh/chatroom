...
export const ChatroomFocusModeToggle = memo(function ChatroomFocusModeToggle({
  ...
  return (
    <button
      type="button"
      className="shrink-0 ml-3 bg-transparent border-0 p-0 cursor-pointer text-chatroom-text-muted hover:text-chatroom-text-secondary transition-colors duration-100 outline-none focus:outline-none focus-visible:outline-none"
      onClick={onToggle}
