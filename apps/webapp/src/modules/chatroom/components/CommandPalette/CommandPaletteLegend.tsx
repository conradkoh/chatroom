...
interface CommandPaletteLegendProps {
  chatroomId: string;
...
/**
 * Legend State–backed Cmd+Shift+P command palette with partition-scoped preload.
 *
 ...
 */
export function CommandPaletteLegend({
  chatroomId,
  workspaceId,
  commands,
  inlineCommand,
}: CommandPaletteLegendProps) {
