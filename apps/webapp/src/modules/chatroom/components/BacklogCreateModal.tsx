...
export function BacklogCreateModal({ isOpen, onClose, onSubmit }: BacklogCreateModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-chatroom-bg-surface border-2 border-chatroom-border w-full max-w-2xl max-h-[80vh] flex flex-col mx-4">
        {/* Header */}
...
**Actual:** Nothing happens"
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t-2 border-chatroom-border bg-chatroom-bg-tertiary">
          <span className="text-[10px] text-chatroom-text-muted">
            Tip: Use markdown for formatting. Press ⌘+Enter to submit.
          </span>
