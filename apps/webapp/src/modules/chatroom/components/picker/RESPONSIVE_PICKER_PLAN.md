...
Future optional helper (slice 2+): `PickerOptionRow` for consistent option button styling.
...
| Component                  | Path                                              | Status  | Notes |
| -------------------------- | ------------------------------------------------- | ------- | ----- |
| HarnessHarnessSelect       | `direct-harness/.../HarnessHarnessSelect.tsx`     | pending |       |
| HarnessAgentSelect         | `direct-harness/.../HarnessAgentSelect.tsx`       | pending |       |
